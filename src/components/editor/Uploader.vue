<template>
  ...
  <div class="editor-drop" :class="{'editor-drag' : this.$store.state.newFileDrag}" @drop.prevent="fileDrop"
    @dragover.prevent="fileDrag" @dragleave.prevent="fileLeave">
